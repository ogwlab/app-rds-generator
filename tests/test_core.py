...
class TestRDSGenerator:
    ...
    def test_generate_rds_full(self):
        ...
        assert result["left_image"].shape == (128, 128)
        assert result["right_image"].shape == (128, 128)
    ...
    def test_different_shapes(self):
        ...
        assert result_rect["left_image"].shape == (128, 128)
        assert result_circle["left_image"].shape == (128, 128)
        assert not np.array_equal(
            result_rect["shape_mask"], result_circle["shape_mask"]
        )
