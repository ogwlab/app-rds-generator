...
class TestMathUtils:
    ...
    def test_phase_shift_symmetry(self):
        ...
        # Apply double shift should approximate original away from reflected edges
        double_shifted = apply_phase_shift_2d_robust(
            shifted_pos, -shift_amount, pad_width=8
        )
        np.testing.assert_allclose(
            double_shifted[4:-4, 4:-4],
            image[4:-4, 4:-4],
            atol=0.2,
        )
